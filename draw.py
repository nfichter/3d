...
def add_sphere( points, cx, cy, cz, r, step ):
    ...
    while i <= n:
    	j = 0
    	while j <= n:
    		x0 = r * math.cos(i*math.pi/n) + cx
    		y0 = r * math.sin(i*math.pi/n) * math.cos(j*2*math.pi/n) + cy
    		z0 = r * math.sin(i*math.pi/n) * math.sin(j*2*math.pi/n) + cz
...
def add_torus( points, cx, cy, cz, r0, r1, step ):
    ...
    while i <= n:
    	j = 0
    	while j <= n:
    		x0 = (r0 * math.cos(i*2*math.pi/n) + r1) * math.cos(j*2*math.pi/n) + cx
    		y0 = r0 * math.sin(i*2*math.pi/n) + cy
    		z0 = (r0 * math.cos(i*2*math.pi/n) + r1) * -1*math.sin(j*2*math.pi/n) + cz
    		add_edge(points,x0,y0,z0,x0,y0,z0)
    		j += step
    	i += step
